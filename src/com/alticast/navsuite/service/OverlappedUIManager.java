...
public class OverlappedUIManager {
    ...
    public Container createOverlappedDialog(int priority, OverlappedDialogHandler handler, int size) {
	if(size == 1)
	    return root;
	
    	return createOverlappedDialog(priority, handler);
    }
	...
	root = hfactory.getBestScene(hst);
	if (root == null) {
