...
public class HScene extends Container implements HComponentOrdering, ImageObserver, MenuContainer, Serializable {
    ...
    public void addWindowListener(WindowListener wl) {        
        windowListener = HEventMulticaster.add(windowListener, wl);
    }

    public void removeWindowListener(WindowListener wl) {
        windowListener = HEventMulticaster.remove(windowListener, wl);
    }
    ...
    protected void processWindowEvent(WindowEvent we) {
        ...
        switch(id) {
          case WindowEvent.WINDOW_ACTIVATED:
            ...
            Debug.write(this, "processWindowEvent, activated");
          break;          
          case WindowEvent.WINDOW_DEACTIVATED:
            windowListener.windowDeactivated(we);
            Debug.write(this, "processWindowEvent, deactivated");
          break;
        }        
    }
