...
public class HStaticAnimation
	...
	//private static Logger logger = Logger.getLogger(HStaticAnimation.class);
	...
	public void start() {
		...
		try{
			...
			logger.debug("Animation starting. delay = " + delay);
		}
		catch(TVTimerScheduleFailedException e){
			logger.error("Start animation failed. error: " + e.getMessage() );
			isRunning = false;
		}
	}
