...
//            mainPanels[STATE_CHOOSE_PATH].add(box);
    ...
    private void back(){
        switch(state){
            ...
            break;
            case STATE_CHOOSE_XLET:
                Debug.write(this, "choose path");
                setChoosePath();
                state = STATE_CHOOSE_PATH;
            break;
            case STATE_FINNISHED:
                Debug.write(this, "choose xlet");
                setChooseXlet();
...
//            }   
            ...
            Debug.write(this, "chosen file " + fc.getSelectedFile());
