...
public class TvWindow extends JFrame implements ActionListener {
    ...
    public TvWindow() {
        ...
        //container.setBackground(Constants.COLOR_DEFAULT_BG);
        ...
        tv = ScreenContainer.getInstance();
        ...
        if(Settings.getProperty("remote.show").equalsIgnoreCase("true")){
        	...
        	try {
        		FileInputStream in = new FileInputStream(new File(Util.getAbsolutePath(ChannelManager.class, "config/remote_control.xml")));
