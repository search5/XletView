...
public class Downloader {
    ...
    public Downloader(String destinationPath) throws IOException {
        synchronized (this){        
            ...
            Debug.write(this, "dest exist? " + destination.exists());
     ...
     */
    public void download(String rootPath) throws IOException{
        synchronized (this){
            flush();
...
*/
    ...
    private void copy() throws AppSizeExceededException {
        Debug.info("downloading resources...");
    ...
    private void deleteFiles(File[] files) {
        Debug.info("unloading any previous application...");
        ...
        for (int i = files.length - 1; i >= 0; i--) {
            ...
            if (deleted) {
                ...
                //could not delete
                success = false;
                Debug.write(this, files[i].getAbsolutePath() + " could not be removed");
            }
        }
        if(!success){
            Debug.info("some resources of the previous application could not be unloaded");
        }
        else{
            Debug.info("unloading successful");
        }
    }
