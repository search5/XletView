...
import net.beiker.xletview.util.FileBrowser;
...
import net.beiker.xletview.io.DirFilter;
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equals("classpath")) {
            ...
            Debug.write(this, "### " + treeData.length);
            ...
            if ( dirWin != null && dirWin.getPath().length() > 0) {
                ...
                Debug.write(this, fields[CLASSPATH].getText());
            }
        }
            ...
            if (fields[CLASSPATH].getText().trim().length() == 0) {
                ...
                Debug.write(this, "value=" + classWindow.getValue());
            ...
            if (isOk()) {
                ...
                Debug.write(this, "name=" + name + ", path=" + path + ", xlet=" + xlet);
