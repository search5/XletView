...
public class ScreenContainer extends Container {
    ...
    private ScreenContainer() {
        ...
        try {
            ...
            layers[ScreenContainer.VIDEO_LAYER] = VideoLayer2.getInstance();
    ...
    public void addToXletContainer(HScene scene) {
        ...
        Debug.write(this, "layers[TV.GRAPHICS_LAYER].getComponentCount() = " + layers[ScreenContainer.GRAPHICS_LAYER].getComponentCount());
    }
